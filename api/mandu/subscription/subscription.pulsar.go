...
func (x *fastReflection_Subscription) Has(fd protoreflect.FieldDescriptor) bool {
	...
	default:
		...
		panic(fmt.Errorf("message mandu.subscription.Subscription does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Subscription) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message mandu.subscription.Subscription does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Subscription) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in mandu.subscription.Subscription", d.FullName()))
	}
	panic("unreachable")
}
...
var File_mandu_subscription_subscription_proto protoreflect.FileDescriptor

var file_mandu_subscription_subscription_proto_rawDesc = []byte{
...
var (
	file_mandu_subscription_subscription_proto_rawDescOnce sync.Once
	file_mandu_subscription_subscription_proto_rawDescData = file_mandu_subscription_subscription_proto_rawDesc
)

func file_mandu_subscription_subscription_proto_rawDescGZIP() []byte {
	file_mandu_subscription_subscription_proto_rawDescOnce.Do(func() {
		file_mandu_subscription_subscription_proto_rawDescData = protoimpl.X.CompressGZIP(file_mandu_subscription_subscription_proto_rawDescData)
	})
...
func file_mandu_subscription_subscription_proto_init() {
	if File_mandu_subscription_subscription_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
	...
	file_mandu_subscription_subscription_proto_rawDesc = nil
	file_mandu_subscription_subscription_proto_goTypes = nil
	file_mandu_subscription_subscription_proto_depIdxs = nil
}
